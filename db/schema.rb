...
ActiveRecord::Schema.define(version: 20171211030728) do
  ...
  create_table "order_has_meals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["meal_id"], name: "index_order_has_meals_on_meal_id", using: :btree
    t.index ["order_id"], name: "index_order_has_meals_on_order_id", using: :btree
  end
